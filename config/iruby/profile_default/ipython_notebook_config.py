...
# variable IPYTHONDIR.
# c.NotebookApp.ipython_dir = u'/root/.config/iruby'
...
# $HOME/.ipython. This options can also be specified through the environment
# variable IPYTHONDIR.
# c.IPKernelApp.ipython_dir = u'/root/.config/iruby'
...
c.KernelManager.kernel_cmd = ["/usr/local/bin/iruby", "kernel", "{connection_file}"]
